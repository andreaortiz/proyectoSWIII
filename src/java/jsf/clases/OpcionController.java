...
import beans.sessions.OpcionFacade;
...
public class OpcionController implements Serializable {
    ...
    @EJB
    private beans.sessions.OpcionFacade ejbFacade;
    ...
    public String create(Pregunta pre) {
        try {
            current.setPreId(pre);
            current.setOpCont(0);
    ...
    public static class OpcionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Opcion) {
                ...
                return getStringKey(o.getOpId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Opcion.class.getName());
            }
        }
